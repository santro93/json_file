...
import 'package:json_project/model/product_data.dart';
...
class _MyHomePageState extends State<MyHomePage> {
    ...
    return Scaffold(
      ...
      builder: (context, data) {
        if (data.hasError) {
          ...
          var items = data.data as List<ProductData>;
  ...
  Future<List<ProductData>> ReadJsonData() async {
    final jsondata =
        await rootBundle.rootBundle.loadString('lib/jsonfile/productlist.json');
